        ...
        <div className="grid grid-cols-2 gap-8 lg:grid-cols-6">
          ...
          >
            <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-black font-bold text-xl">ResumerAI.</span>
            </div>
            <p className="text-sm text-gray-600 mb-6 max-w-xs">
              Build professional, ATS-friendly resumes powered by AI. Land your dream job faster with our intelligent resume builder.
            </p>
            {/* Social Links */}
