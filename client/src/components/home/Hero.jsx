  ...
  return (
    <section className="flex flex-col items-center text-sm bg-[url('https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/hero/bg-with-grid.png')] bg-cover bg-center bg-no-repeat">
      ...
      <main className="flex flex-col items-center max-md:px-2">
        ...
        <motion.a
          href="#"
          className="mt-32 flex items-center gap-2 border border-gray-300 rounded-full p-1 pr-3 text-sm font-medium text-gray-700 bg-white/60"
        ...
        >
          <button className="flex items-center gap-2 bg-black hover:bg-gray-800 text-white active:scale-95 rounded-md px-7 h-11 transition">
            Get started
            <svg
              width="20"
              height="20"
          ...
          <button className="border border-gray-300 active:scale-95 hover:bg-gray-50 transition text-gray-700 rounded-md px-8 h-11">
            Pricing
          </button>
        </motion.div>
